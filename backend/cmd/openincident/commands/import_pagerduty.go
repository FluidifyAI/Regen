...
and creates matching records in the OpenIncident database.
...
A JSON report is written to --report (default: oi-import-report.json).`,
		Example: `  openincident import pagerduty --api-key=u+xxxx
  openincident import pagerduty --api-key=u+xxxx --force
  openincident import pagerduty --api-key=u+xxxx --dry-run`,
