...
func SecurityHeaders() gin.HandlerFunc {
	...
	// script-src us-assets.i.posthog.com — PostHog JS client loads its config bundle from this CDN (OPE-79)
	// connect-src us.i.posthog.com       — PostHog analytics capture endpoint (write-only; OPE-79)
	// connect-src us-assets.i.posthog.com — PostHog config fetch (OPE-79)
	...
	const csp = "default-src 'self'; " +
		...
		"connect-src 'self' https://us.i.posthog.com https://us-assets.i.posthog.com https://static.fluidify.ai; " +
		"font-src 'self'; " +
		"object-src 'none'; " +
		"base-uri 'self'; " +
