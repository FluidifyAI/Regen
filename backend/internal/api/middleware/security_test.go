...
func TestSecurityHeaders(t *testing.T) {
	...
	assert.Equal(t, "default-src 'self'; script-src 'self' https://us-assets.i.posthog.com; style-src 'self' 'unsafe-inline'; img-src 'self' data: https://cdn.jsdelivr.net; connect-src 'self' https://us.i.posthog.com https://us-assets.i.posthog.com https://static.fluidify.ai; font-src 'self'; object-src 'none'; base-uri 'self'; frame-ancestors 'none'; form-action 'self'", w.Header().Get("Content-Security-Policy"),
