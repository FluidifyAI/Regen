...
import { previewOnCallMigration, importOnCallMigration } from '../../api/migrations'
...
type Mode = 'choose' | 'grafana' | 'manual'
    ...
    <div className="space-y-4">
      ...
      <div className="grid gap-3">
        ...
        <div className="flex items-start gap-3 rounded-lg border border-border bg-surface-secondary/40 px-4 py-3 opacity-60 cursor-not-allowed">
          ...
          <div>
            <p className="text-sm font-medium text-text-primary">PagerDuty</p>
